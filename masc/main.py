...
def main():
    ...
    parser.add_argument('-cr', '--run-compiled-rules',
                        help='Running Compiled rules will help in saving memory of your system', action='store_true')
    parser.add_argument('-c', '--clean-site', help='Clean up the site (and apply some extra actions to hide information to attackers)',
                        action='store_true')
